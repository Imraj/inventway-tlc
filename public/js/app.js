...
apptlc.controller("HomeCtrl",["$scope","$state","$rootScope","AuthFactory","FileUploader",
                          function($scope,$state,$rootScope,AuthFactory,FileUploader){
  ...
  $scope.user.uploader = new FileUploader();
